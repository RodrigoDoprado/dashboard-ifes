    ...
    return(
      <nav className="sb-topnav navbar navbar-expand navbar-dark bg-primary">
        <div className="container-fluid">
           ...
           <button className="btn btn-link btn-lg order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" onClick={navigation}><FontAwesomeIcon icon={faBars} size="xl" style={{color: "#f7f7f7"}} /></button>
